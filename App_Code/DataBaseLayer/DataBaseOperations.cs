    ...
    public class DataBaseOperations
    {
        ...
        //public SqlDataReader DataReader;
            ...
            public int parameterCount;
             ...
             public string[] fieldsOfTable = new string[25];
             public string[] valuesOfField = new string[25];
             public string[] storedProcedureParametersNames = new string[25];
             public string[] storedProcedureParametersvaluesOfFields = new string[25];
        ...
        public string connectToDataBase()
           {
               //connection.ConnectionString = @"Data Source=164.138.19.49,1433;Network Library=DBMSSOCN;Initial Catalog=montaser_ALPSNT_BusinessSite;User ID=montaser_vahid123456vahid;Password= vahid123456@;";

               connection.ConnectionString = @"Data Source=164.138.19.49,1433;Initial Catalog= montaser_ALPSNT_BusinessSite;User ID= montaser_vahid123456vahid; Password=abas454933@";
            
            //@"Data Source=.;Initial Catalog=BusinessSite;User ID=sa;Password=montaserisoftwaredatabase"; 

            //@"Data Source=164.138.19.49,1433;Network Library=DBMSSOCN;Initial Catalog=montaser_ALPSNT_BusinessSite;User ID=montaser_vahid123456vahid;Password= vahid123456@;"

                   
              //@"Data Source=74.63.251.194,1533;Network Library=DBMSSOCN;Initial Catalog=alpsntirw_BusinessSite;User ID=alpsntirw_vahid123456vahid;Password= vahid123456@;"; 
            
             //@"Data Source=.;Initial Catalog=BusinessSite;User ID=sa;Password=montaserisoftwaredatabase";   
            //connection.ConnectionString = @"Data Source=74.63.251.194,1533;Network Library=DBMSSOCN;Initial Catalog=alpsnt_BusinessSite;User ID=alpsnt_vahid123456vahid;Password= vahid123456@;";
               //"Data Source=.;Initial Catalog=MySite;Integrated Security=true";
              //@"Data Source=SABASMN\MSSQLSERVER2008;Initial Catalog=BusinessSite;Integrated Security=True"
                try
                {
