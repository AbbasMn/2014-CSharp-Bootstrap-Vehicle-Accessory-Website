    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                if (dt.Rows[0]["newsUploadedFileType"].ToString() == string.Empty)
                {
                ...
                ImageButton1.PostBackUrl = "~/NewsFiles/" + dt.Rows[0]["newsUploadedFileName"].ToString();

                if (dt.Rows[0]["newsUploadedFileType"].ToString() == ".PDF")
                {
                    ImageButton1.ImageUrl = "~/NewsFiles/downloadicon/pdf.jpg";
                    
                }

                if (dt.Rows[0]["newsUploadedFileType"].ToString() == ".RAR")
                {
                    ImageButton1.ImageUrl = "~/NewsFiles/downloadicon/rar.jpg";
                    
                }
                else
                    if (dt.Rows[0]["newsUploadedFileType"].ToString() == ".ZIP")
                {
                    ImageButton1.ImageUrl = "~/NewsFiles/downloadicon/zip.jpg";
                    
                }
                else
                        if (dt.Rows[0]["newsUploadedFileType"].ToString() == ".DOC")
                {
                    ImageButton1.ImageUrl = "~/NewsFiles/downloadicon/doc.jpg";
                    
                }
                else
                            if (dt.Rows[0]["newsUploadedFileType"].ToString() == ".DOCX")
                {
                    ImageButton1.ImageUrl = "~/NewsFiles/downloadicon/docx.jpg";
                    
                }
                else
                                if (dt.Rows[0]["newsUploadedFileType"].ToString() == ".PPTX")
                {
                    ImageButton1.ImageUrl = "~/NewsFiles/downloadicon/pptx.jpg";

                }
                else
                                    if (dt.Rows[0]["newsUploadedFileType"].ToString() == ".PPT")
                    {
                        ImageButton1.ImageUrl = "~/NewsFiles/downloadicon/ppt.jpg";
